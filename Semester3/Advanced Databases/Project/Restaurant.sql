...
WHERE WastageDate BETWEEN '2000-01-01' AND '3000-01-01' 
...
FROM
    RestaurantFact
        JOIN
    IngredientDimension ON RestaurantFact.IngredientID = IngredientDimension.IngredientID
WHERE
    SaleDate BETWEEN '2000-01-01' AND '3000-01-01'
GROUP BY IngredientName; 